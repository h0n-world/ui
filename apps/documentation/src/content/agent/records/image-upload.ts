...
export const imageUploadAgentRecord = {
    ...
    examples: [{ key: 'components/image-upload/BasicExample', purpose: 'Single-image selection and preview.' }, { key: 'components/image-upload/PresetsExample', purpose: 'Avatar, square, and custom empty upload surfaces.' }, { key: 'components/image-upload/BannerPresetExample', purpose: 'Fluid banner upload surface.' }, { key: 'components/image-upload/VerticalPresetExample', purpose: 'Tall portrait upload surface.' }, { key: 'components/image-upload/LoadingExample', purpose: 'Centered spinner-only pending state.' }, { key: 'components/image-upload/DisabledExample', purpose: 'Unavailable avatar upload.' }, { key: 'components/image-upload/ErrorExample', purpose: 'Banner upload with external validation feedback.' }], relatedComponents: ['H0FileUpload', 'H0Image', 'H0Form'],
