...
export const inputOtpAgentRecord = {
    ...
    imports: { components: ['H0InputOTP'], types: ['H0InputOTPEmits', 'H0InputOTPLength', 'H0InputOTPProps', 'H0InputOTPValidation', 'H0InputOTPValidator', 'H0InputOTPVariant'], styles: ['@h0nio/ui/style.css'] },
    api: { props: [
        ...
        { name: 'length', type: '4 | 6', default: '6', description: 'Number of cells.' }, { name: 'variant', type: "'secondary' | 'surface'", default: "'secondary'", description: 'Visual treatment.' },
    ...
    examples: [{ key: 'components/input-otp/BasicExample', purpose: 'Six-digit verification code.' }, { key: 'components/input-otp/VariantsExample', purpose: 'Four and six cells with both validation modes.' }, { key: 'components/input-otp/ValidationExample', purpose: 'Custom validation and manual confirmation.' }], relatedComponents: ['H0Input', 'H0Form'],
