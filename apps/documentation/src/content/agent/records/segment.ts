...
export const segmentAgentRecord = {
    ...
    imports: { components: ['H0Segment'], types: ['H0SegmentEmits', 'H0SegmentItem', 'H0SegmentProps', 'H0SegmentSize', 'H0SegmentValue', 'H0SegmentVariant'], styles: ['@h0nio/ui/style.css'] },
    api: { props: [
        ...
        { name: 'H0SegmentItem', fields: [
            { name: 'label', type: 'string', description: 'Visible and accessible choice label.' }, { name: 'value', type: 'H0SegmentValue', description: 'Stable selection value.' }, { name: 'icon', type: 'H0IconDefinition | undefined', description: 'Optional leading icon.' }, { name: 'disabled', type: 'boolean | undefined', description: 'Disables this choice.' },
        ] },
    ] },
