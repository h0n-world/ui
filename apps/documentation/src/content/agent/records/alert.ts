...
export const alertAgentRecord = {
    ...
    imports: { components: ['H0Alert'], types: ['H0AlertEmits', 'H0AlertProps', 'H0AlertTone', 'H0AlertVariant'], styles: ['@h0nio/ui/style.css'] },
    api: {
        props: [
            ...
            { name: 'variant', type: 'H0AlertVariant', default: "'surface'", description: 'Surface, secondary, or outline container appearance, independent from semantic tone.' },
        ...
        exposed: [],
        types: [
            { name: 'H0AlertTone', fields: [{ name: 'H0AlertTone', type: "'default' | 'info' | 'success' | 'warning' | 'danger'", description: 'Available semantic visual tones.' }] },
            { name: 'H0AlertVariant', fields: [{ name: 'H0AlertVariant', type: "'secondary' | 'surface' | 'outline'", description: 'Supported container appearances.' }] },
        ],
    },
    ...
    styling: ['Use variant for container appearance and tone for semantic intent.', 'Provide text and actionText fallbacks when rich slots require non-compact layout.', 'Treat the alert grid and state selectors as implementation details.'],
    ...
    examples: [
        { key: 'components/alert/VariantsExample', purpose: 'Surface, secondary, and outline container appearances.' },
