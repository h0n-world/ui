...
export const radioAgentRecord = {
    schemaVersion: 1, component: 'H0Radio', status: 'migrated', summary: 'Standalone native radio control with label, description, validation, and programmatic focus.',
    imports: { components: ['H0Radio'], types: ['H0RadioEmits', 'H0RadioProps', 'H0RadioValidator', 'H0RadioValue'], styles: ['@h0nio/ui/style.css'] },
    api: { props: [
        { name: 'modelValue', type: 'H0RadioValue', default: 'undefined', description: 'Controlled selected value.' }, { name: 'defaultValue', type: 'H0RadioValue', default: 'undefined', description: 'Initial selected value.' }, { name: 'value', type: 'H0RadioValue', description: 'Value represented by this radio.' },
    ...
    examples: [{ key: 'components/radio/BasicExample', purpose: 'Standalone and card choices.' }, { key: 'components/radio/GroupExample', purpose: 'Horizontal list group.' }, { key: 'components/radio/ValidationExample', purpose: 'Required card group and exposed validation.' }], relatedComponents: ['H0RadioGroup', 'H0Form'],
