...
export const sheetAgentRecord = {
    ...
    api: {
        props: [
            ...
            { name: 'closeAriaLabel', type: 'string', default: "''", description: 'Accessible label for the standard header close button.' },
        ...
        slots: [
            { name: 'default', type: '—', description: 'Scrollable sheet content between the optional standard header and footer.' },
    ...
    accessibility: ['Provide a visible title or meaningful ariaLabel.', 'Keep a visible completion or close action.', 'Do not imply that the decorative handle is draggable.'],
