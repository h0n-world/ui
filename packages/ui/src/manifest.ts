...
const localeSections: Record<string, string> = {
    DataTable: 'dataTable', EmptyState: 'emptyState', Field: 'field', FileUpload: 'fileUpload', ImageUpload: 'imageUpload', InfiniteScroll: 'infiniteScroll', Input: 'common', InputOTP: 'inputOtp', Link: 'link',
